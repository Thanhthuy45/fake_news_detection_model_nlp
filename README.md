...
- file: xoatrunglap_tinh_chỉnh_distilbert.ipynb : file thực hiện tinh chỉnh mô hình distilbert nhưng khác với những mô hình trước ở việc xử lý phần dữ liệu bị trùng lặp nhằm giúp mô hình học tốt hơn.
